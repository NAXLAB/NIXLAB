    ...
    model: Quickshell.screens
        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                State {
                    name: "bar"
                    PropertyChanges { target: launcherRows; visible: false }
                    PropertyChanges { target: searchBox; visible: false }
                    PropertyChanges { target: root; width: 200; height: 48 }
                },
                State {
                    name: "launcher"
                    PropertyChanges { target: launcherRows; visible: true }
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        // ── App icon buttons ────────────────────────────────────────────
                        // Each icon slot is 42px wide; the hit area is 42×44 (bleeds top/bottom).
                        // Duplicate / replace these Items with a Repeater over your app list.
